...
export interface Doctor { id: string; name: string; title: string; specialty: string; branch: Branch; branch_label: string; branches: string[]; branches_labels: string[]; service_ids: string[]; dentsoft_id: string; photo: string; bio: string; education: string[]; expertise: string[]; booking_url: string; is_active: boolean; sort_order: number; }

...
export interface Service { id: string; title: string; description: string; icon: string; color_from: string; color_to: string; image: string; price_range: string; is_featured: boolean; is_active: boolean; sort_order: number; }

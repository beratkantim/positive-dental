...
export function Home() {
  ...
  const activeDoctors = allDoctors.filter((d: Doctor) => d.is_active);
  const activeBranches = allBranches.filter((b: BranchData) => b.is_active);
  ...
  return (
    ...
    <div className="bg-white overflow-hidden">
      ...
      {/* ── GEÇIŞ ── */}
      <div className="h-10 sm:h-14 bg-gradient-to-b from-white to-[#0D1235]" />
        ...
        <section className="pt-4 sm:pt-8 pb-8 sm:pb-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex sm:grid sm:grid-cols-2 gap-4 overflow-x-auto sm:overflow-visible snap-x snap-mandatory pb-4 sm:pb-0 -mx-4 px-4 sm:mx-0 sm:px-0 scrollbar-hide">
              {activeBranches.map((b: BranchData, i: number) => (
